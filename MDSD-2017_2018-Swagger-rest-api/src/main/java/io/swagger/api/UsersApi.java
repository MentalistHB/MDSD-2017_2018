...
public interface UsersApi {
	...
	@ApiOperation(value = "Create user", notes = "This can only be done by the logged in user.", response = User.class, tags = {
			"User", })
	...
	@RequestMapping(value = "/users/logout/{token}", produces = { "application/json" }, method = RequestMethod.DELETE)
